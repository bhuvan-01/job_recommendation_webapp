...
const JobUpdatePopup = ({ job, onClose, onUpdate }) => {
  const [skills, setSkills] = useState(job.requirements || []);
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      await onUpdate(job._id, updatedData);
