...
const UserDashboardContent = () => {
    ...
    const fetchJobs = async () => {
      ...
      try {
        ...
        if (res.status === 200) {
          ...
          const limitedJobs = res.data.slice(0, 50);
          dispatch(searchResultsReceived(limitedJobs));
          dispatch(storeJobs(limitedJobs));
        }
      } catch (error) {
  ...
  return (
    <div className="container px-0 max-w-[1400px] mx-auto w-[95%] md:flex gap-4 my-4">
