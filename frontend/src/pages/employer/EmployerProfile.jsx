...
// import { updateCompanyDetails } from '../slices/authSlice'; // Assuming you have an action to update company details
...
const EmployerProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('res company: ', companyRes);
      ...
      if (companyRes.status === 201) {
        ...
        console.log('update res: ', userUpdateRes);
